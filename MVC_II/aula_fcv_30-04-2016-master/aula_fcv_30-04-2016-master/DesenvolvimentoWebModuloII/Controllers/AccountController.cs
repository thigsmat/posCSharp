...
using DesenvolvimentoWebModuloII.Providers;
using DesenvolvimentoWebModuloII.Results;

namespace DesenvolvimentoWebModuloII.Controllers
{
    [Authorize]
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> RemoveLogin(RemoveLoginBindingModel model)
        {
            ...
            result = model.LoginProvider == LocalLoginProvider ? await UserManager.RemovePasswordAsync(User.Identity.GetUserId()) : await UserManager.RemoveLoginAsync(User.Identity.GetUserId(),
